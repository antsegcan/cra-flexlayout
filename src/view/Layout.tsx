...
export class Layout extends React.Component<ILayoutProps, ILayoutState> {
  ...
  /** @hidden @internal */
  private outlineDiv?: any;

  /** @hidden @internal */
  private edgeRightDiv?: any;
  /** @hidden @internal */
  private edgeBottomDiv?: any;
  /** @hidden @internal */
  private edgeLeftDiv?: any;
  /** @hidden @internal */
  private edgeTopDiv?: any;
  /** @hidden @internal */
  ...
  componentDidMount() {
    ...
    this.currentDocument = (this.selfRef
      .current as HTMLDivElement).ownerDocument;
  ...
  updateLayoutMetrics = () => {
    if (this.findHeaderBarSizeRef.current) {
      const headerBarSize = this.findHeaderBarSizeRef.current.getBoundingClientRect()
        .height;
    ...
    if (this.findTabBarSizeRef.current) {
      const tabBarSize = this.findTabBarSizeRef.current.getBoundingClientRect()
        .height;
    ...
    if (this.findBorderBarSizeRef.current) {
      const borderBarSize = this.findBorderBarSizeRef.current.getBoundingClientRect()
        .height;
  ...
  renderChildren(
    ...
    const drawChildren: any[] = node._getDrawChildren() || [];

    for (const child of drawChildren!) {
      if (child._attributes.type === "splitter") {
        splitterComponents.push(
          <Splitter key={child.getId()} layout={this} node={child} />
        );
      } else if (child._attributes.type === "tabset") {
      ...
      } else if (child._attributes.type === "tab") {
